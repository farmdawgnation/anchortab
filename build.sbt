...
libraryDependencies ++= {
  ...
  Seq(
    ...
    "org.eclipse.jetty" % "jetty-webapp"        % "9.2.0.M1"  % "compile,container",
    ...
    "org.seleniumhq.selenium" % "selenium-java" % "2.9.0" % "it",
    "org.apache.httpcomponents" % "httpclient"  % "4.3.3"  % "it",
    "com.newrelic.agent.java" % "newrelic-api"  % "3.6.0",
