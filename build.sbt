...
libraryDependencies ++= {
  ...
  Seq(
    ...
    "org.eclipse.jetty" % "jetty-webapp"        % "9.2.2.v20140723"  % "compile,container",
    ...
    "org.seleniumhq.selenium" % "selenium-java" % "2.42.2" % "it",
    "org.apache.httpcomponents" % "httpclient"  % "4.3.5"  % "it",
